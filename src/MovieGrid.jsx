...
const MovieGrid = ({ onSelectMovie }) => {
  ...
  function handleSORT2() {
    if (sort != "primary_release_date") setSORT("primary_release_date");
    else setSORT(null);
  ...
  return (
    <div className="right-container">
      <div id="search">
        ...
        <span onClick={handleReset} id="clear">
          <p>Clear</p>
        </span>
        <span id="dropdown">
          <p>Sort:</p>
          <p className="sortingoption" onClick={handleSORT1}>
            @-A
          </p>
          <p className="sortingoption" onClick={handleSORT2}>
            date
          </p>
          <p className="sortingoption" onClick={handleSORT3}>
            rating
          </p>
        </span>
      </div>
